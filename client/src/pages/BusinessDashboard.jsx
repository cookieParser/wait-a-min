                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center min-w-0 flex-shrink">
                            <Clock className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-500 flex-shrink-0" />
                            <span className="ml-2 font-bold text-gray-900 dark:text-white tracking-tight text-sm sm:text-base">WaitClarity</span>
                            <span className="mx-1 sm:mx-2 text-gray-200 dark:text-gray-700">/</span>
                            <span className="text-[10px] sm:text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest hidden sm:inline">Dashboard</span>
                        </div>
                        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
                            ...
                            <button
                                ...
                                className="flex items-center text-xs sm:text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors uppercase tracking-tight"
                            >
